...
#ifndef EMMax72xxPanel_h
#define EMMax72xxPanel_h
...
class EMMax72xxPanel : public Adafruit_GFX {
...
public:
   ...
   */
  EMMax72xxPanel(byte mosiPin, byte clkPin, byte csPin, byte hDisplays=1, byte vDisplays=1);
