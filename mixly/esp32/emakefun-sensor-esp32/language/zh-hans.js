(() => {
    ...
    ZhHans.EM_PIANOPORT_V2 = "初始化钢琴模块V2";
    ZhHans.EM_PIANO_NUM = "数字";
    ZhHans.EM_PIANO_ISTOUCH="被触摸";
	...
	ZhHans.EM_I2CDCMOTOR = "初始化DM11 I2C双路电机驱动板地址为";
	ZhHans.EM_DM11_DCMOTOR_PIN = "电机引脚";
	ZhHans.EM_dm11_DCMOTOR_SPEED = "速度(0-4095)";
	ZhHans.EM_DCMOTOR_DIRECTION_PIN = "方向引脚";
	ZhHans.EM_DCMOTOR_DIRECTION = "方向";
	ZhHans.EM_DCMOTOR_FORWORD = "正转";
	ZhHans.EM_DCMOTOR_BACK = "反转";

    ZhHans.EM_INITVK16K33 = "初始化VK16K33数码管";
    ZhHans.EM_I2C_VK16K33_ADDR = "I2C地址为";
    ZhHans.EM_VK16K33 = "VK16K33数码管";
    ZhHans.EM_VK16K33_SET_BRIGHTNESS = "设置亮度为";
    ZhHans.EM_VK16K33_SHOW_DATA = "显示数字";
    ZhHans.EM_VK16K33_SHOW_COLON = "时钟点设置";
    ZhHans.EM_VK16K33_DISPLAY = "显示";
    ZhHans.EM_VK16K33_NOT_DISPLAY = "隐藏";
