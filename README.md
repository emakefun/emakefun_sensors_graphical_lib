...
[该模块是我们公司通过结合广大创客爱好者提供的需求]()，大力研发的一款循迹模块，它能够更好、更方便的控制循迹小车，该模块通过IIC通信，地址为：**0x50**

**描述：**

五路循迹模块获取单路探头：![five_track_one](E:\github\emakefun_sensors_graphical_lib\media\mixly\five_track_one.png) 选择对应的探头，当该探头检测到黑线时，输出高电平，否则输出低电平；

五路循迹模块获取状态值：![five_track_data](E:\github\emakefun_sensors_graphical_lib\media\mixly\five_track_data.png) 获取五个探头的状态，每一位代表一个探头，比如当返回值为0x01时，代表第一组探头检测到黑线，当返回值为0x03时，代表第一第二组探头都检测到了黑线(探头从左至右)。
